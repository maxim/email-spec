...
Gem::Specification.new do |s|
  ...
  s.test_files = [
    "spec/email_spec",
     ...
     "examples/rails3_root/app/views/layouts",
     ...
     "examples/rails3_root/db/development.sqlite3",
     ...
     "examples/rails3_root/db/test.sqlite3",
     ...
     "examples/rails3_root/log/development.log",
     "examples/rails3_root/log/production.log",
     "examples/rails3_root/log/server.log",
     "examples/rails3_root/log/test.log",
